...
vdom.HtmlTovDOM('<div id="lol xd" :id="var i = [100, 20]; var res = ``; res = i[0] + ` ` + i[1]; res"><i :if="this.datas.num">Italic text: {{ this.datas.num + 5 }}, {{ this.datas.text }}</i><br><b>Bold text: {{ this.datas.num }} {{ this.datas.text.toUpperCase() }}</b></div>');
